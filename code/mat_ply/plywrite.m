...
for i = 1:NumElements
   ...
   %tmp = eval(['isa(Elements.',ElementNames{i},',''struct'');']);
   ...
   for j = 1:length(PropertyNames{i})
      ...
      %!!! change by J. Knopp , 12-Jan-2009
% to save in the int32 instead of int16 format
%    Type{2}(1) =  14;
%!!! end of the J. Knopp change , 12-Jan-2009
