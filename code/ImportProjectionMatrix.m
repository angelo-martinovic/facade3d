function P = ImportProjectionMatrix(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   P = IMPORTFILE1(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   P = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   P = importfile1('00000000.txt', 2, 4);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2013/09/11 10:49:13
