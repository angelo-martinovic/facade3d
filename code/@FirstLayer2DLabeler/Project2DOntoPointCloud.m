function Project2DOntoPointCloud(obj)
    ...
    for i=1:nImages
        ...
        labelingFilename = get_adr('image_classifier_unaries',obj.config,obj.config.c2D.name,basename);
    ...
    ExportMesh(get_adr('pcl_labeling',obj.config,'2D_layer1_majorityVote') ,points,[],newColors_L1,[],[]);
    ExportMesh(get_adr('pcl_labeling',obj.config,'2D_layer2_majorityVote') ,points,[],newColors_L2,[],[]);
