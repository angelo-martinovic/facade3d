function Project2DOntoPointCloud(obj)
    ...
    for i=1:nImages
        ...
        labelingFilename = get_adr('2D_classifier_unaries',obj.config,obj.classifierName,basename);
    ...
    fprintf('Exporting point clouds...');
    ExportMesh(get_adr('3D_L1_labeling',obj.config,'seg_majorityVote') ,points,[],newColors_L1,[],[]);
    ExportMesh(get_adr('3D_L1_labeling',obj.config,'seg+det_majorityVote') ,points,[],newColors_L2,[],[]);

    save(get_adr('3D_L1_unaries',obj.config,'2D'),'unary','unaryDet');
    fprintf('Done!\n');
